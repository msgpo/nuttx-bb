...
#include <nuttx/sercomm/linuxlist.h>
#include <nuttx/irq.h>
...
void timer_init(void)
{
	...
	irq_attach(IRQ_TIMER2, (xcpt_t)timer_irq);
	up_prioritize_irq(IRQ_TIMER2, -1); //was irq_config(IRQ_TPU_FRAME, 1, 1, 0); //TODO
	up_enable_irq(IRQ_TIMER2);
}
